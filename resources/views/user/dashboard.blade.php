                        ...
                        @forelse($announcements as $announcement)
                            <div class="announcement-item item-hover announcement-hover p-4 rounded cursor-pointer" 
                                 @click="activeModal = {
                                    ...
                                    shareToken: '{{ $announcement->share_token }}',
                                    shareUrl: '{{ $announcement->share_token ? url('/share/announcement/'.$announcement->share_token) : '' }}'
                                 }">
                        ...
                        @forelse($events as $event)
                            <div class="announcement-item item-hover event-hover p-4 rounded cursor-pointer" 
                                 @click="activeModal = {
                                    ...
                                    shareUrl: '{{ $event->share_token ? url('/share/event/'.$event->share_token) : '' }}'
                                 }">
                        ...
                        @forelse($news as $article)
                            <div class="announcement-item item-hover news-hover p-4 rounded cursor-pointer" 
                                 @click="activeModal = {
                                    ...
                                    shareUrl: '{{ $article->share_token ? url('/share/news/'.$article->share_token) : '' }}'
                                 }">
