    ...
    <div class="main-content">
        ...
        <div class="visibility-notice">
            ...
            <div class="notice-content">
                <h4><i class="fas fa-info-circle"></i> News Visibility</h4>
                <p>All news created by {{ Auth::guard('admin')->user()->office_display }} will be visible to <strong>all students and faculty</strong> when published. The news will show "Posted by {{ Auth::guard('admin')->user()->office_display }}".</p>
            </div>
        </div>
