...
@section('title', 'Create News - Office Admin')
...
<div class="dashboard">
    ...
    <div class="main-content">
        <div class="header">
            <div>
                <h1><i class="fas fa-newspaper"></i> Create News Article</h1>
                <p style="margin: 0; color: var(--text-secondary); font-size: 0.875rem;">Publish a news update from {{ Auth::guard('admin')->user()->office_display }}</p>
            </div>
        ...
        @if(Auth::guard('admin')->user()->office === 'NSTP')
            ...
            <div class="nstp-visibility-notice">
                ...
                <div class="notice-content">
                    <h4><i class="fas fa-info-circle"></i> NSTP News Visibility</h4>
                    <p>This news article will be visible to <strong>all 1st year students</strong> across all departments (Bachelor of Science in Information Technology, Bachelor of Science in Business Administration, Bachelor of Elementary Education, Bachelor of Science in Hospitality Management, Bachelor of Secondary Education) when published.</p>
                </div>
            </div>
        @endif

        <div class="form-container">
            <form method="POST" action="{{ route('office-admin.news.store') }}" enctype="multipart/form-data" class="news-form">
                @csrf
                            ...
                            <div class="nstp-auto-visibility">
                                <div class="auto-visibility-card">
                                    ...
                                    <div class="auto-visibility-content">
                                        ...
                                        <p>This news will automatically be visible to <strong>all 1st year students</strong> across all departments when published.</p>
