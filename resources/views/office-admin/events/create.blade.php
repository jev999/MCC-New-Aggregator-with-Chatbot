...
@section('title', 'Create Event - Office Admin')
    ...
    <div class="main-content">
        <div class="header">
            <div>
                ...
                <p style="margin: 0; color: var(--text-secondary); font-size: 0.875rem;">Schedule a new event from {{ Auth::guard('admin')->user()->office_display }}</p>
            </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <div class="checkbox-group">
                            ...
                            <small class="form-help">Check this box to make the event visible to all users immediately. If unchecked, it will be saved as a draft and won't be visible until published later.</small>
                        </div>
                    </div>
                </div>
