...
<head>
    ...
    <title>Create Student - Super Admin</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <div class="page-header">
                <h1><i class="fas fa-user-plus"></i> Create Student</h1>
            ...
            <div class="form-container">
                <form action="{{ route('superadmin.students.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="year_level" name="year_level" class="department-select" required>
