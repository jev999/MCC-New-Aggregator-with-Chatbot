...
@section('title', 'Edit Student - Super Admin')
...
<div class="dashboard">
    ...
    <div class="main-content">
        <div class="enhanced-header student-edit-header">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <a href="{{ route('superadmin.students.index') }}" class="btn-modern btn-secondary">
        ...
        <div class="profile-card">
            <div class="profile-header">
                ...
                <div class="profile-info">
                    ...
                    <p>Student ID: #{{ str_pad($student->id, 4, '0', STR_PAD_LEFT) }}</p>
        ...
        <div class="form-container">
            <div class="form-header">
                <h3><i class="fas fa-edit"></i> Student Information</h3>
                <p>Update the student's personal and contact information</p>
            </div>
            
            <form method="POST" action="{{ route('superadmin.students.update', $student->id) }}" class="enhanced-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="department"
                            ...
                            <option value="Bachelor of Science in Information Technology" {{ old('department', $student->department) == 'Bachelor of Science in Information Technology' ? 'selected' : '' }}>Bachelor of Science in Information Technology</option>
                            <option value="Bachelor of Science in Business Administration" {{ old('department', $student->department) == 'Bachelor of Science in Business Administration' ? 'selected' : '' }}>Bachelor of Science in Business Administration</option>
                            <option value="Bachelor of Elementary Education" {{ old('department', $student->department) == 'Bachelor of Elementary Education' ? 'selected' : '' }}>Bachelor of Elementary Education</option>
                            <option value="Bachelor of Science in Hospitality Management" {{ old('department', $student->department) == 'Bachelor of Science in Hospitality Management' ? 'selected' : '' }}>Bachelor of Science in Hospitality Management</option>
                            <option value="Bachelor of Secondary Education" {{ old('department', $student->department) == 'Bachelor of Secondary Education' ? 'selected' : '' }}>Bachelor of Secondary Education</option>
                        </select>
                        @error('department')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <select id="year_level"
                                name="year_level"
                                class="form-input @error('year_level') error @enderror"
                                required>
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="email" 
                               id="ms365_account" 
                               name="ms365_account" 
                               value="{{ old('ms365_account', $student->ms365_account) }}" 
...
document.querySelector('.enhanced-form').addEventListener('submit', function(e) {
    ...
    if (!firstName || !surname || !email || !department || !yearLevel) {
        e.preventDefault();
