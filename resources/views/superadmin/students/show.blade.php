            ...
            <div class="details-container">
                ...
                <div class="text-center" style="margin-bottom: 2rem;">
                    ...
                    <span class="year-level-badge">
                        <i class="fas fa-graduation-cap"></i> {{ $student->year_level }}
                    </span>
                    @endif
                </div>
                ...
                <div class="details-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value">#{{ str_pad($student->id, 4, '0', STR_PAD_LEFT) }}</div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $student->ms365_account }}</div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $student->year_level ?? 'Not Set' }}</div>
                    </div>
                    ...
                    <div class="detail-item">
                        <div class="detail-label">
                            <i class="fas fa-calendar-plus"></i> Enrolled Date
                        </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $student->updated_at->format('F d, Y g:i A') }}</div>
                    </div>

                    <div class="detail-item">
                        <div class="detail-label">
                            <i class="fas fa-history"></i> Student Since
                        </div>
                        <div class="detail-value">{{ $student->created_at->diffForHumans() }}</div>
                    </div>
                </div>

                <div class="actions-container">
                    <a href="{{ route('superadmin.students.edit', $student->id) }}" class="btn btn-primary">
