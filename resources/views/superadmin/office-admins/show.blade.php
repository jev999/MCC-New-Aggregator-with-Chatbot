...
<body>
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <div class="header">
                <h1><i class="fas fa-eye"></i> Office Admin Details</h1>
            ...
            <div class="detail-container">
                <div class="admin-profile">
                    <div class="admin-avatar" onclick="document.getElementById('profilePictureInput').click()">
                        @if($officeAdmin->hasProfilePicture)
                            <img src="{{ $officeAdmin->profilePictureUrl }}" alt="{{ $officeAdmin->username }}" id="profileImage">
                    ...
                    <div class="admin-name">
                        {{ $officeAdmin->username }}
                        @if($officeAdmin->id === auth('admin')->id())
                            <span class="current-user-badge">You</span>
                        @endif
                    </div>
                    <div class="admin-role role-admin">
                        <i class="fas fa-user-shield"></i> Office Administrator
                    </div>
                </div>
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value">#{{ $officeAdmin->id }}</div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $officeAdmin->username }}</div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            {{ $officeAdmin->created_at->format('F d, Y \a\t g:i A') }}
                        </div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            {{ $officeAdmin->updated_at->format('F d, Y \a\t g:i A') }}
                        </div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            {{ $officeAdmin->announcements->count() + $officeAdmin->events->count() + $officeAdmin->news->count() }} items
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function uploadProfilePicture(input) {
        ...
        fetch(`/superadmin/office-admins/{{ $officeAdmin->id }}/upload-picture`, {
            method: 'POST',
            headers: {
    ...
    function removeProfilePicture() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`/superadmin/office-admins/{{ $officeAdmin->id }}/remove-picture`, {
                    method: 'DELETE',
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest',
                        'X-CSRF-TOKEN': csrfToken
