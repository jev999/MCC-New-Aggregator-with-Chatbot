...
@section('title', 'View Event - Department Admin')
    ...
    <div class="main-content">
        ...
        <div class="header">
            ...
            <div class="header-actions">
                <a href="{{ route('department-admin.events.index') }}" class="btn-action-view">
        ...
        <div class="content-card">
            ...
            <div class="announcement-meta">
                ...
                <div class="meta-item">
                    ...
                    <div>
                        ...
                        <div class="meta-value">{{ $event->admin->username ?? 'Unknown' }}</div>
                    </div>
                </div>
                <div class="meta-item">
            ...
            @php
                ...
                $imagePaths = $event->image_paths;
                $videoPaths = $event->video_paths;
                $singleImage = $event->image_path;
                $singleVideo = $event->video_path;
                ...
                <div class="media-section">
                    ...
                    <div class="media-grid">
                        ...
                        @if(!empty($imagePaths) && is_array($imagePaths))
                            @foreach($imagePaths as $image)
                                <div class="media-item">
                                    <img src="{{ storage_asset($image) }}" alt="Event Image" onclick="openImageModal(this.src)">
                                </div>
                            @endforeach
                        @endif
                        ...
                        @if($singleImage && (empty($imagePaths) || !is_array($imagePaths)))
                            <div class="media-item">
                                <img src="{{ storage_asset($singleImage) }}" alt="Event Image" onclick="openImageModal(this.src)">
                            </div>
                        @endif
...
<script>
    ...
    function confirmDelete(eventTitle) {
        ...
        Swal.fire({
            title: 'Delete Event?',
            html: `Are you sure you want to delete "<strong>${eventTitle}</strong>"?<br><br>This action cannot be undone.`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#ef4444',
            cancelButtonColor: '#6b7280',
    ...
    function confirmPublish(eventTitle) {
        event.preventDefault();
        
        Swal.fire({
            title: 'Publish Event?',
            html: `Are you sure you want to publish "<strong>${eventTitle}</strong>"?<br><br>This will make it visible to all users.`,
            icon: 'question',
            showCancelButton: true,
    ...
    function confirmUnpublish(eventTitle) {
        event.preventDefault();
        
        Swal.fire({
            title: 'Unpublish Event?',
            html: `Are you sure you want to unpublish "<strong>${eventTitle}</strong>"?<br><br>This will hide it from all users.`,
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: 'Unpublishing...',
                    text: 'Please wait while we unpublish the event',
                    allowOutsideClick: false,
                    allowEscapeKey: false,
                    showConfirmButton: false,
                    didOpen: () => {
