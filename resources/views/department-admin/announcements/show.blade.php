...
@section('title', 'View Announcement - Department Admin')
    ...
    <div class="main-content">
        ...
        <div class="header">
            ...
            <div class="header-actions">
                <a href="{{ route('department-admin.announcements.index') }}" class="btn-action-view">
            ...
            <div class="announcement-meta">
                ...
                <div class="meta-item">
                    ...
                    <div>
                        ...
                        <div class="meta-value">{{ $announcement->admin->username ?? 'Unknown' }}</div>
                    </div>
                </div>
                <div class="meta-item">
                ...
                <div class="media-section">
                    ...
                    <div class="media-grid">
                        ...
                        @if(!empty($imagePaths) && is_array($imagePaths))
                            @foreach($imagePaths as $image)
                                <div class="media-item">
                                    <img src="{{ storage_asset($image) }}" alt="Announcement Image" onclick="openImageModal(this.src)">
                                </div>
                            @endforeach
                        @endif
                        ...
                        @if($singleImage && (empty($imagePaths) || !is_array($imagePaths)))
                            <div class="media-item">
                                <img src="{{ storage_asset($singleImage) }}" alt="Announcement Image" onclick="openImageModal(this.src)">
                            </div>
                        @endif
