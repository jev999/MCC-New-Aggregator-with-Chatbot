...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <p>Department Admin Registration</p>
        </div>
        ...
        <div class="content">
            ...
            <p>You have been invited to become a Department Admin for the <strong>{{ $department }}</strong> department in the MCC News Aggregator system.</p>
            
            <div class="info-box">
                <h3>📧 Registration Details</h3>
                <p><strong>Email:</strong> {{ $email }}</p>
                <p><strong>Department:</strong> {{ $department }}</p>
                <p><strong>Role:</strong> Department Admin</p>
            </div>
            
            <p>As a Department Admin, you will be able to:</p>
            <ul>
                <li>Create and manage announcements for your department</li>
                <li>Post and manage events for your department</li>
                <li>Create and manage news articles for your department</li>
                <li>View and manage faculty and students in your department</li>
            </ul>
