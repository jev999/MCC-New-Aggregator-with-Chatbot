...
<head>
    ...
    <title>Password Reset Request - MCC News Aggregator</title>
...
<body>
    <div class="auth-container">
        ...
        <div class="auth-content">
            <div class="greeting">
                <i class="fas fa-user-circle"></i> Hello {{ $user->first_name ?? 'User' }},
            </div>

            <div class="user-info">
                <p><strong><i class="fas fa-envelope"></i> Account:</strong> {{ $user->ms365_account }}</p>
                <p><strong><i class="fas fa-user"></i> Name:</strong> {{ $user->full_name ?? ($user->first_name . ' ' . $user->surname) }}</p>
            ...
            <div class="message">
                <i class="fas fa-info-circle"></i> We received a request to reset your password for your MCC News Aggregator account. 
            ...
            <div class="expiry-notice">
                <i class="fas fa-clock"></i> This link will expire in 60 minutes for security reasons.
            </div>
            ...
            <div class="security-notice">
                ...
                <ul>
                    ...
                    <li>For security, this link will expire in 1 hour</li>
                    <li>Never share this link with anyone</li>
                </ul>
            </div>

            <div class="message">
                <i class="fas fa-question-circle"></i> If you're having trouble accessing your account or didn't request this reset, 
        ...
        <div class="footer">
            ...
            <p>© {{ date('Y') }} MCC-NAC. All rights reserved.</p>
        </div>
    </div>
</body>
</html>